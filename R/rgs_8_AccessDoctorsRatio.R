...
execIndicatorAccessDoctorsRatio <- function(){
  ...
  boundary@data = boundary@data[,c("sa2_name11","sa3_name11","sa4_name11","gcc_name11.x","ste_name11.x","podiatrists","medical_practitioners_nfd","general_medical_practitioners","special_physicians","surgeons","other_medical_practitioners","total.y","accdoc")]
